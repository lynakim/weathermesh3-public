...
ls = sorted([x for x in os.listdir(base) if x.startswith(sys.argv[1]) and x.endswith(".grib")])
#ls = [x for x in ls if x >= "oldoutput618_2021092706.grib"]
#ls = [x for x in ls if x >= "oldoutput618_2022050518.grib"]
bad = 0
for fn in ls:
    print("------------ file", fn, "------------------")
