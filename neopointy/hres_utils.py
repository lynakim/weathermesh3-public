...
default_config.lr_sched.lr = 0.5e-4
...
#default_config.initial_gradscale = 32768.
...
default_config.weights = np.array([4.5, 4.5, 4.5, 4, 4, 0.8, 0.2, 2], dtype=np.float32)
#default_config.weights[3:] = 0

pr_levels = np.array([100, 500, 1000]) # this is in meters actually! haha