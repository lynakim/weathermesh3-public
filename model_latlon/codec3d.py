...
from model_latlon.codec2d import *


# 3d gets pretty chuncky, and I dont' care about details as much. So only one resblock per layer    
...
if __name__ == "__main__":
    e = EarthConvEncoder3d(4, conv_dims=[64,192,576,1024],depth_strides=[2,1,2])
