...
load_path = '/huge/deep/runs_diffusion/run_Nov16-diffusion-combined_20241118-181112/model_epoch0_iter73797_step24599_loss0.107.pt'
from diffusion.model import UNet
...
forecaster = ForecastModel(mesh,conf)
...
with torch.no_grad():
    ...
    with torch.autocast(enabled=True, device_type='cuda', dtype=torch.float16):
        gen = model.generate(x,0,steps=100).cpu().detach()
