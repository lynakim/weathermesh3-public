...
class PointDataset(Dataset):
    ...
    def load_era5(dt: datetime) -> Dict:
        ...
        ex = []
        for e in extra:
            a = np.load("/fast/proc/era5/extra/%s/%04d%02d/%d.npz" % (e, dt.year, dt.month, timestamp))["x"]
            if a.shape[0] == 1:
                a = a[0]
    ...
    def get_by_date(self, dt, do_era5=True):
        ...
        # Get ERA5 data.
        if do_era5:
            era5_data = PointDataset.load_era5(dt)
        else:
            era5_data = None
...
if __name__ == '__main__':
    d = PointDataset(100)
    print("this line shouldn't print when imported")
