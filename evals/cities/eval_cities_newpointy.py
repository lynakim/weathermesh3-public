...
pointy_ckpt_path = '/huge/deep/runs_hres/run_Sep24-oldnewslop_20240930-143452/model_step494500_loss0.209.pt'
pointy_ckpt_path = '/huge/deep/runs_hres/run_Sep24-oldnewslop_20241016-165042/model_step279000_loss0.191.pt'
...
for month in [7, 8]:
    for day in tqdm(range(1, 32)):
        ...
        with open("/fast/wbhaoxing/deep/evals/cities/city_newnewpointy_errors_summer.json", "w") as f:
